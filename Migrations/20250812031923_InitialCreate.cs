...
namespace cabapi.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Comentarios",
                columns: new[] { "Id", "Activo", "Calificacion", "FechaHora", "ProductoId", "Texto", "UsuarioId" },
                values: new object[,]
                {
                    { 1, true, 5, new DateTime(2025, 7, 10, 10, 30, 0, 0, DateTimeKind.Unspecified), 2, "Excelente sistema de clasificación automática. Muy útil para nuestro centro de trabajo.", 3 },
                    { 2, true, 5, new DateTime(2025, 7, 15, 14, 20, 0, 0, DateTimeKind.Unspecified), 1, "La precisión del clasificador es impresionante. Recomiendo totalmente este producto.", 3 },
                    { 3, true, 4, new DateTime(2025, 7, 20, 16, 45, 0, 0, DateTimeKind.Unspecified), 1, "Fácil instalación y excelentes resultados. El soporte técnico es muy bueno.", 3 }
                });
